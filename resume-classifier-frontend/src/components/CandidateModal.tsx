                    ...
                    {result.error ? (
                        ...
                        <>
                            ...
                            <div>
                                ...
                                <div className="flex items-center gap-2 text-white/70 bg-zinc-900 border border-zinc-800 p-3 text-sm">
                            ...
                            <div>
                                ...
                                <div className="bg-zinc-900 border border-zinc-800 p-4 text-sm leading-relaxed text-white/60 font-mono text-justify">
